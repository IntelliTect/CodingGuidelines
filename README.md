...
## 03XX block - Performance Suggestions
#### INTL0300 - Favor using the method `EnumerateFiles` over the `GetFiles` method.
...
#### INTL0301 - Favor using the method `EnumerateDirectories` over the `GetDirectories` method.
